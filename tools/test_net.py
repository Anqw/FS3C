...
It is an entry point that is made to evaluate standard models in Fs3c.
...
Therefore, we recommend you to use Fs3c as an library and take
...
from fs3c.config import get_cfg, set_global_cfg
from fs3c.data import MetadataCatalog
from fs3c.engine import (
    DefaultTrainer,
