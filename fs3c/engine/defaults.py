...
import fs3c.data.transforms as T
from fs3c.checkpoint import DetectionCheckpointer
from fs3c.data import (
    MetadataCatalog,
...
from fs3c.solver import build_lr_scheduler, build_optimizer
from fs3c.utils import comm
from fs3c.utils.collect_env import collect_env_info
from fs3c.utils.env import seed_all_rng
from fs3c.utils.events import CommonMetricPrinter, JSONWriter, TensorboardXWriter
from fs3c.utils.logger import setup_logger
...
def default_argument_parser():
    ...
    """
    parser = argparse.ArgumentParser(description="Fs3c Training")
    parser.add_argument(
        "--config-file",
        default="",
        metavar="FILE",
...
class DefaultTrainer(SimpleTrainer):
    ...
    def __init__(self, cfg):
        ...
        if cfg.SSL:
            data_loader_ssl = self.build_ssl_loader(cfg)
        else:
            data_loader_ssl = None
        ...
        super().__init__(model, data_loader, optimizer, data_loader_ssl)
    ...
    def build_ssl_loader(cls, cfg):
        ...
        Overwrite it if you'd like a different data loader.
        """
        return build_ssl_train_loader(cfg)
